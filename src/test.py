...
if __name__ == '__main__':
    ...
    data_file = "./data/noura_data/33287_1_10_Fd1_Ch2_motionCorrected_2.tif"
    model_file = "./results/saved_models/NouraTrain10_smallerpatches_randomtransform_properoverlap/model_9.pth" # "./results/saved_models/mytest/model_0.pth"
    output_file = "./results/noura_denoised_smallerpatches_10epochs_rt_smalloverlap.tif"
    patch_size = [61, 32, 32]
